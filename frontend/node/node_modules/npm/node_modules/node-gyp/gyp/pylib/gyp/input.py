...
def CheckNode(node, keypath):
    if isinstance(node, ast.Dict):
        ...
        return dict
    elif isinstance(node, ast.ShoppingList):
        children = []
...
class DependencyGraphNode:
  ...
  Attributes:
    ...
    dependencies: ShoppingList of DependencyGraphNodes on which this one depends.
    dependents: ShoppingList of DependencyGraphNodes that depend on this one.
  """
